...
withProgress(message = 'Initializing app', value = 0.1, {
  
  setProgress(0, detail = paste("Reading annotations table"))
  ...
  setProgress(0.3, detail = paste("Reading annotations"))
  ...
  setProgress(0.4, detail = paste("Reading annotations: GO terms"))
  ...
  setProgress(0.5, detail = paste("Reading annotations: KEGG terms"))
  ...
  setProgress(0.7, detail = paste("Reading annotations: KEGG pathways"))
  ...
  ## aws variables
  setProgress(0.8, detail = paste("Defining App variables"))
  ...
  setProgress(0.9, detail = paste("Defining App variables"))
  
  degs <- c()
  rv <- reactiveValues(gsea_plots = NULL,
                       IP = NULL, 
                       show_menu_fastqc = FALSE,
