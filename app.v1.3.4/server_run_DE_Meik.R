...
if(dim(single_replicates)[1] == 0){
  ...
  print("To few replicates")
  html("overview_text", paste("WARNING: to few replicates per group/donor.", "</br>", "Try again selecting more replicates or reconfigure your contrast naming"))
