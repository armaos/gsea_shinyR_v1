removeTab("tabs_plots_gsea_dynamic", gsea_cond)
removeTab("tabs_running_score_dynamic", gsea_cond)
          ...
          tabPanel(gsea_cond,
                   tabsetPanel(type = "tabs",
                               tabPanel("Dot Plot",
                                        ...
                                        withSpinner(plotOutput(paste0("dotplot_gsea_", gsea_cond), height = "600px"), type = 6 )),
                               tabPanel("Ridge Plot",
                                        p(id = paste0("gsea_ridgeplot_text_", gsea_cond), "Processing..."),
                                        withSpinner(plotOutput(paste0("ridgeplot_gsea_", gsea_cond), height = "600px"), type = 6 ))
                   )
          )
)
...
appendTab(inputId = "tabs_running_score_dynamic",
          tabPanel(gsea_cond,
                  ...
                  withSpinner(plotOutput(paste0("gseaplot_", gsea_cond), height = "600px"), type = 6)
                   # ) 
                   #)
          )
)
