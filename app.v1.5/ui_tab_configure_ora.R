  ...
  shinyjs::hidden(
    div(id = "box_ora_send_to_plot",
        box(
          ...
          sliderInput("ORA_max_elements_1",
                      label = p("Maximum terms per plot to show:
                                (BarPlot, DotPlot, Heatmap, TreePlot, UpSetPlot"), min = 1,
                      max = 100, value = 20),
          sliderInput("ORA_max_elements_2",
                      label = p("Maximum terms per plot to show: 
                                (Enrichment Map, Gene Concept Network,"), min = 1,
                      max = 100, value = 20),
